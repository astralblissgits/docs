...
### Acess marketplace without UI

1. Go to the spotify search bar.


2. Type:

```spotify:app:marketplace```

3. The marketplace should open and if it doesn't you haven't installed marketplace correctly.
